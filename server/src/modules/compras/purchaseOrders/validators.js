...
const createValidators = [
  body('supplierId').isMongoId().withMessage('supplierId must be a valid id'),
  ...itemsValidators,
...
module.exports = { createValidators, receiveValidators, listValidators };
